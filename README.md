...
| **Changes** | Weights that are small but sit on critical computation paths are preserved. Only weights that are both small *and* unimportant to the loss landscape are pruned. |
